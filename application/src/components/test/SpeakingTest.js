...
import { faAlignCenter, faMicrophone, faTimes } from '@fortawesome/free-solid-svg-icons';
import Microphone from '../utilities/Microphone';
import * as sdk from 'microsoft-cognitiveservices-speech-sdk';
import SpeechToElement from 'speech-to-element';
import { ToggleWebSpeech } from '../utilities/ToggleSpeech';
import BotSpeaker from '../chat/BotSpeaker';
import './css/test-speaking.css';

function SpeakingTest({ type, questions, setAnswers, setTypeTestEnd }) {
        ...
        <div className="card-body">
            ...
            <div className="mb-3 text-start">
                <h5 className="headline">
                    {currentQuestionIndex + 1}. <BotSpeaker text={questions[currentQuestionIndex]} />
                </h5>
